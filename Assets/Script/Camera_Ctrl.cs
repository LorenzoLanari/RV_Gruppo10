...
public class Camera_Ctrl: MonoBehaviour
{
	...
	float turnSmoothing = 0; //Smooths all camera movements (Time it takes the camera to reach the rotation indicated with the joystick)
	...
	public static Camera_Ctrl singleton; //You can call CameraManager.singleton from other script (There can be only one)
	void Awake()
	{
